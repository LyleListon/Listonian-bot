...
class MetricsManager:
    ...
    def __init__(
        ...
        self._running = convert_to_string(False)  # Convert to string
        self._update_task = None
        self.initialized = convert_to_string(False)
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            self._running = convert_to_string(True)
            self._update_task = asyncio.create_task(self._update_loop())
            self.initialized = convert_to_string(True)
...
def create_metrics_manager(
    ...
    try:
        ...
        try:
            ...
            if not success:
                raise ValueError("Failed to initialize metrics manager")
        finally:
            loop.close()
