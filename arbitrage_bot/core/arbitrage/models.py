...
class ArbitrageOpportunity:
    ...
    def is_executable(self) -> bool:
        ...
        return (
            ...
            self.price_validated and
            self.liquidity_validated and
            self.confidence_score >= 0.8 and
            datetime.now() < self.execution_deadline
        )
...
class ExecutionResult:
    ...
    def is_successful(self) -> bool:
        ...
        return (
            ...
            self.transaction_status == TransactionStatus.CONFIRMED and
            self.actual_profit_wei is not None and
            self.actual_profit_wei > 0
        )
