...
# Gas cost estimates
GAS_COSTS = {
    "v2": {"base_cost": 100000, "hop_cost": 50000, "buffer": 1.1},
    "v3": {"base_cost": 150000, "hop_cost": 60000, "buffer": 1.1},
}
...
def validate_config(
    config: Dict[str, Any], required_keys: Dict[str, type]
...
def get_common_base_tokens() -> List[str]:
    ...
    return [COMMON_TOKENS["WETH"], COMMON_TOKENS["USDC"], COMMON_TOKENS["DAI"]]
