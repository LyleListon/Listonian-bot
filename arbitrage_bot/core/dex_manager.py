...
class DEXManager:
    ...
    def _get_dex_type(self, name: str) -> Optional[DEXType]:
        ...
        if name == "aerodrome":
            ...
            return DEXType.SWAPBASED_V3  # Use V3 by default since SwapBased is V3-based
    ...
    async def initialize_dex(self, name: str) -> Optional[BaseDEX]:
        ...
        try:
            ...
            try:
                ...
                elif dex_type == DEXType.SWAPBASED_V3:
                    from ..dex.swapbased_v3 import SwapBasedV3
                    dex = SwapBasedV3(self.web3, dex_config)
                    logger.info(f"Created SwapBased V3 instance")
