...
class PortfolioTracker:
    ...
    async def _get_token_price_from_alchemy(
            ...
            try:
                if weth_address:
                    ...
                    if eth_price:
                        ...
                        logger.debug(
                            "Portfolio value: $%.2f (ETH price: $%.2f)",
                            portfolio_value_usd,
                            eth_price,
                        )
    ...
    async def add_trade(self, trade_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            clean_trade = {
                ...
                "profit_percent": trade_data.get("opportunity", {}).get(
                    "profit_percent"
                ),
            ...
            try:
                ...
                logger.info(
                    "Trade recorded: profit=$%.2f, gas=$%.2f",
...
async def create_portfolio_tracker(
    ...
    try:
        ...
        tracker = PortfolioTracker(
            web3_manager=web3_manager, wallet_address=wallet_address, config=config
        )
