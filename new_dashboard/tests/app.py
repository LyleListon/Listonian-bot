    ...
    async def get_execution_stats(self) -> Dict[str, Any]:
        ...
        if random.random() > 0.2:  # 80% success rate
            ...
            profit = random.randint(
                Web3.to_wei(0.01, "ether"), Web3.to_wei(0.1, "ether")
            )
        ...
        return {
            ...
            "avg_profit": (
                self._total_profit // self._execution_count
                if self._execution_count > 0
                else 0
            ),
            "avg_gas": (
                self._total_gas // self._execution_count
                if self._execution_count > 0
                else 0
            ),
        }
...
async def get_metrics():
    ...
    try:
        ...
        return {
            ...
            "totalProfit": execution_stats["avg_profit"]
...
async def get_status():
    ...
    try:
        return {
            "status": "running",
            "web3_connected": bool(
                system.web3_manager and system.web3_manager.w3.is_connected()
            ),
